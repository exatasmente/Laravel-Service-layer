...
final class CreatePropertyContractDto extends AbstractDto implements DtoInterface
{
    ...
    protected function configureValidatorRules(): array
    {
        return [
            ...
            'email' => 'required|email|unique:contracts,email|unique:properties,owner_email',
            'name' => 'required',
